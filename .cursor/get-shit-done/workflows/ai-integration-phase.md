...
<required_reading>
@/home/domini/src/My/Surypus/.cursor/get-shit-done/references/ai-frameworks.md
@/home/domini/src/My/Surypus/.cursor/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/domini/src/My/Surypus/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/domini/src/My/Surypus/.cursor/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/domini/src/My/Surypus/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/domini/src/My/Surypus/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/domini/src/My/Surypus/.cursor/agents/gsd-eval-planner.md for instructions.
