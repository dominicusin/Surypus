...
Key references:
- @/home/domini/src/My/Surypus/.cursor/get-shit-done/references/ui-brand.md (display patterns)
- @/home/domini/src/My/Surypus/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/domini/src/My/Surypus/.cursor/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md" "/home/domini/src/My/Surypus/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/domini/src/My/Surypus/.cursor/get-shit-done/references/user-profiling.md`
...
Reference: @/home/domini/src/My/Surypus/.cursor/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /home/domini/src/My/Surypus/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/domini/src/My/Surypus/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/domini/src/My/Surypus/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/home/domini/src/My/Surypus/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /home/domini/src/My/Surypus/.cursor/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/domini/src/My/Surypus/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       .cursor/rules/
  ✓ Global .cursor/rules/        /home/domini/src/My/Surypus/.cursor/.cursor/rules/
```
