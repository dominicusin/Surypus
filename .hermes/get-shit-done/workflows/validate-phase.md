...
```
Agent(
  prompt="Read /home/domini/src/My/Surypus/.hermes/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/domini/src/My/Surypus/.hermes/get-shit-done/templates/VALIDATION.md`
