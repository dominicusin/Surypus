...
@/home/domini/src/My/Surypus/.augment/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/domini/src/My/Surypus/.augment/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
...
Use the Write tool to create files — never use `launch-process(cat << 'EOF')` or heredoc commands for file creation. This rule applies regardless of `commit_docs` setting.
