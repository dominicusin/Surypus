...
- **Global scope**: `/home/domini/src/My/Surypus/.augment/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/domini/src/My/Surypus/.augment/notes/`)
...
2. Glob `/home/domini/src/My/Surypus/.augment/notes/*.md` (if directory exists) — global notes
...
Global (/home/domini/src/My/Surypus/.augment/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/domini/src/My/Surypus/.augment/notes/` — works in any directory
