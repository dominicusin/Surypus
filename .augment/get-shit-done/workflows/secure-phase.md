...
```
Agent(
  prompt="Read /home/domini/src/My/Surypus/.augment/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/domini/src/My/Surypus/.augment/get-shit-done/templates/SECURITY.md`
