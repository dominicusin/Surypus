...
`./.augment/skills/spike-findings-[project]/` (project-local) and summary to
...
- [ ] Spike-findings skill exists at `./.augment/skills/` with SKILL.md (including requirements), references/, sources/
