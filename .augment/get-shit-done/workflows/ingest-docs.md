...
```bash
INIT=$(node "/home/domini/src/My/Surypus/.augment/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/domini/src/My/Surypus/.augment/get-shit-done/bin/gsd-tools.cjs" commit \
