...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/domini/src/My/Surypus/.trae/.gsd-surface.json`
(sibling to `/home/domini/src/My/Surypus/.trae/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/domini/src/My/Surypus/.trae/skills/gsd-*/`.
...
(`/home/domini/src/My/Surypus/.trae`), NOT the skills sub-directory (`/home/domini/src/My/Surypus/.trae/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/domini/src/My/Surypus/.trae` as `configDir`. The skill dirs themselves live at
`/home/domini/src/My/Surypus/.trae/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Trae — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/domini/src/My/Surypus/.trae}"
SCOPE="global"
...
(i.e. `/home/domini/src/My/Surypus/.trae/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/domini/src/My/Surypus/.trae/.gsd-surface.json`
Install profile marker: `/home/domini/src/My/Surypus/.trae/.gsd-profile`
Skill dirs: `/home/domini/src/My/Surypus/.trae/skills/gsd-*/`
Engine module: `/home/domini/src/My/Surypus/.trae/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/domini/src/My/Surypus/.trae/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
