...
const CLAUDE_MD_FALLBACKS = {
  ...
  skills: 'No project skills found. Add skills to any of: `.trae/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/`, or `.codex/skills/` with a `SKILL.md` index file.',
};
...
function cmdGenerateClaudeMd(cwd, options, raw) {
  ...
  try {
    ...
    // regardless of claude_md_path, so Codex projects never write to .trae/rules/.
