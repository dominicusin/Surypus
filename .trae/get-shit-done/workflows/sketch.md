...
@/home/domini/src/My/Surypus/.trae/get-shit-done/references/sketch-theme-system.md
@/home/domini/src/My/Surypus/.trae/get-shit-done/references/sketch-variant-patterns.md
@/home/domini/src/My/Surypus/.trae/get-shit-done/references/sketch-interactivity.md
@/home/domini/src/My/Surypus/.trae/get-shit-done/references/sketch-tooling.md
</required_reading>
...
**b. Findings skills** — glob `./.trae/skills/sketch-findings-*/SKILL.md` and read any that exist, plus their `references/*.md`. These contain curated design decisions from prior wrap-ups.
...
**a.** Glob for `./.trae/skills/spike-findings-*/SKILL.md` and read any that exist, plus their `references/*.md`. These contain validated patterns and requirements.
