...
- Saves timestamped note to `.planning/notes/` (or `/home/domini/src/My/Surypus/.trae/notes/` globally)
...
- **`/gsd-ultraplan-phase [phase]`** — [BETA] Offload plan phase to Trae's ultraplan cloud; review in browser and import back.
