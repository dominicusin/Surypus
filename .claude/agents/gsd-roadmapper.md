...
Reference full template: `/home/domini/src/My/Surypus/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/domini/src/My/Surypus/.claude/get-shit-done/templates/state.md`.
