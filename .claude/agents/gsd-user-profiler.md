...
<reference>
@/home/domini/src/My/Surypus/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/domini/src/My/Surypus/.claude/get-shit-done/references/user-profiling.md` to load:
