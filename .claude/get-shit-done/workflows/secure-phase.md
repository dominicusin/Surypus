...
```
Agent(
  prompt="Read /home/domini/src/My/Surypus/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/domini/src/My/Surypus/.claude/get-shit-done/templates/SECURITY.md`
