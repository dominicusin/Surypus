# OpenPapyrusHS - Формально верифицированная система

## Архитектура

Проект OpenPapyrusHS представляет собой формально верифицированную систему ERP, переписанную с C++ (OpenPapyrus) на Haskell с использованием LiquidHaskell для математического доказательства корректности.
...
| C++ класс (OpenPapyrus) | Haskell модуль |
|--------------------------|-----------------|
