...
```bash
INIT=$(node "/home/domini/src/My/Surypus/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/domini/src/My/Surypus/.kilo/get-shit-done/templates/spec.md.
