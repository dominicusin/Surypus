...
<required_reading>
@/home/domini/src/My/Surypus/.windsurf/get-shit-done/references/domain-probes.md
@/home/domini/src/My/Surypus/.windsurf/get-shit-done/references/gate-prompts.md
@/home/domini/src/My/Surypus/.windsurf/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/home/domini/src/My/Surypus/.windsurf/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
```bash
SPIKE_FINDINGS=$(ls ./.windsurf/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1 || true)
SKETCH_FINDINGS=$(ls ./.windsurf/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1 || true)
...
Read `@/home/domini/src/My/Surypus/.windsurf/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
