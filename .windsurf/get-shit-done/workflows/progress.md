...
> for project name, milestone, current phase, and next-step routing. .windsurf/rules ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> .windsurf/rules project description as a source for any progress report field.
