...
- Saves timestamped note to `.planning/notes/` (or `/home/domini/src/My/Surypus/.windsurf/notes/` globally)
...
- **`/gsd-ultraplan-phase [phase]`** — [BETA] Offload plan phase to Windsurf's ultraplan cloud; review in browser and import back.
