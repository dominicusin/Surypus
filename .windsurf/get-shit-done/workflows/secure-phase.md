...
```
Agent(
  prompt="Read /home/domini/src/My/Surypus/.windsurf/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/domini/src/My/Surypus/.windsurf/get-shit-done/templates/SECURITY.md`
