...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/domini/src/My/Surypus/.qwen/.gsd-surface.json`
(sibling to `/home/domini/src/My/Surypus/.qwen/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/domini/src/My/Surypus/.qwen/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/domini/src/My/Surypus/.qwen/skills`).
...
`/home/domini/src/My/Surypus/.qwen/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Qwen Code — global install
...
(i.e. `/home/domini/src/My/Surypus/.qwen/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/domini/src/My/Surypus/.qwen/.gsd-surface.json`
Install profile marker: `/home/domini/src/My/Surypus/.qwen/.gsd-profile`
Skill dirs: `/home/domini/src/My/Surypus/.qwen/skills/gsd-*/`
Engine module: `/home/domini/src/My/Surypus/.qwen/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/domini/src/My/Surypus/.qwen/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
