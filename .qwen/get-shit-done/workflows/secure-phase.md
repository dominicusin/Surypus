...
```
Agent(
  prompt="Read /home/domini/src/My/Surypus/.qwen/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/domini/src/My/Surypus/.qwen/get-shit-done/templates/SECURITY.md`
