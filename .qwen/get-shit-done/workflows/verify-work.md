...
<template>
@/home/domini/src/My/Surypus/.qwen/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/domini/src/My/Surypus/.qwen/get-shit-done/workflows/transition.md`.
...
- Follow @/home/domini/src/My/Surypus/.qwen/get-shit-done/workflows/diagnose-issues.md
