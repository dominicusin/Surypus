...
@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/ui-brand.md
@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/revision-loop.md
@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/gate-prompts.md
@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/agent-contracts.md
@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/gates.md
</required_reading>
...
- Planner is instructed to produce `SKELETON.md` in the phase directory alongside `PLAN.md`. The template lives at `@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/skeleton-template.md`.
...
**If found:**
1. Read template: `/home/domini/src/My/Surypus/.qwen/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/home/domini/src/My/Surypus/.qwen/get-shit-done/references/tdd.md to all eligible tasks:
...
**MVP_MODE:** ${MVP_MODE} (when true, follow vertical-slice rules from `@/home/domini/src/My/Surypus/.qwen/get-shit-done/references/planner-mvp-mode.md`; when false, ignore MVP guidance entirely.)
...
${MVP_MODE === 'true' ? `
<mvp_mode_active>
**MVP Mode is ENABLED.** Follow vertical-slice planning rules from @/home/domini/src/My/Surypus/.qwen/get-shit-done/references/planner-mvp-mode.md. Each plan must deliver a complete vertical slice — thin end-to-end functionality rather than horizontal layers.
</mvp_mode_active>
` : ''}
</planning_context>
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "/home/domini/src/My/Surypus/.qwen/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
