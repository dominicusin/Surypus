...
Template for project-root `QWEN.md` — auto-generated by `gsd-tools generate-claude-md`.
...
**Fallback text:**
```
No project skills found. Add skills to any of: `.qwen/skills/`, `.agents/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.
```

**Discovery behavior:**
- Scans `.qwen/skills/`, `.agents/skills/`, `.cursor/skills/`, `.github/skills/` for subdirectories containing `SKILL.md`
...
QWEN.md file and no profile section exists yet.
