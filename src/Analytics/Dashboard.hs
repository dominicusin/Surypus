...
getKPIData kpiName = do
  ...
  return $ case kpiName of
    ...
    "customers" -> [("Total Customers", 5000.0), ("New This Month", 120.0), ("Churn Rate", 2.1)]
    "transactions" -> [("Total Transactions", 12500.0), ("Avg Order Value", 85.0), ("Conversion Rate", 3.2)]
    _ -> [("Data", 0.0)]
...
getTimeSeriesData query = do
  ...
  return
    ...
    , DataPoint { dpLabel = "Mar", dpValue = 140.0, dpColor = "#52c41a" }
...
getTopProducts limit = do
  ...
  return
    ...
    , DataPoint { dpLabel = "Product B", dpValue = 65000.0, dpColor = "#faad14" }
