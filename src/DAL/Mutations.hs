...
createPerson pool input = do
  ...
  case res of
    Right pid -> return $ QuerySuccess (MutationResult True (Just pid) (T.pack "Person created successfully"))
...
updatePerson pool pid input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just pid) (T.pack "Person updated successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
deletePerson pool pid = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just pid) (T.pack "Person deleted successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
createGoods pool input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right gid -> return $ QuerySuccess (MutationResult True (Just gid) (T.pack "Goods created successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
updateGoods pool gid input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just gid) (T.pack "Goods updated successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
deleteGoods pool gid = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just gid) (T.pack "Goods deleted successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
createBill pool input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right bid -> return $ QuerySuccess (MutationResult True (Just bid) (T.pack "Bill created successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
updateBillStatus pool bid status = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just bid) (T.pack "Bill status updated"))
    Left err -> return $ QueryError (T.pack $ show err)
...
postBill pool bid = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just bid) (T.pack "Bill posted successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
addBillLine pool bid input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right blid -> return $ QuerySuccess (MutationResult True (Just blid) (T.pack "Bill line added"))
    Left err -> return $ QueryError (T.pack $ show err)
...
createLocation pool input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right lid -> return $ QuerySuccess (MutationResult True (Just lid) (T.pack "Location created successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
updateLocation pool lid input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just lid) (T.pack "Location updated successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
deleteLocation pool lid = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right _ -> return $ QuerySuccess (MutationResult True (Just lid) (T.pack "Location deleted successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
updateStock pool goodsId locationId qty = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right sid -> return $ QuerySuccess (MutationResult True (Just sid) (T.pack "Stock updated"))
    Left err -> return $ QueryError (T.pack $ show err)
...
reserveStock pool goodsId locationId qty = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right sid -> return $ QuerySuccess (MutationResult True (Just sid) (T.pack "Stock reserved"))
    Left err -> return $ QueryError (T.pack $ show err)
...
releaseStock pool goodsId locationId qty = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right sid -> return $ QuerySuccess (MutationResult True (Just sid) (T.pack "Stock released"))
    Left err -> return $ QueryError (T.pack $ show err)
...
createOrder pool input = do
  ...
  res <- use pool $ Session.statement () stmt
  case res of
    Right oid -> return $ QuerySuccess (MutationResult True (Just oid) (T.pack "Order created successfully"))
    Left err -> return $ QueryError (T.pack $ show err)
...
updateUser _ _ = return $ QuerySuccess (MutationResult True Nothing (T.pack "User stub - not implemented"))
