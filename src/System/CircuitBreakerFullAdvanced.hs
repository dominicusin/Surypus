module System.CircuitBreakerFullAdvanced where
...
-- | Full-featured circuit breaker with topology and advanced metrics
data CircuitBreakerFullAdvanced = CircuitBreakerFullAdvanced
...
initCircuitBreakerFullAdvanced :: CircuitConfig -> CircuitTopology -> IO CircuitBreakerFullAdvanced
initCircuitBreakerFullAdvanced config topology = do
...
-- | Execute with full circuit protection and topology awareness
executeWithCircuitFullAdvanced :: CircuitBreakerFullAdvanced -> IO a -> IO (Either Text a)
executeWithCircuitFullAdvanced breaker action = do
