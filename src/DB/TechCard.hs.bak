...
createTechCard pool pid gid kind formula = use pool $
...
addTechLine pool techId lineNo goodsId qty sign formula lineTime lineCost = use pool $
...
listTechLines pool techId = use pool $
