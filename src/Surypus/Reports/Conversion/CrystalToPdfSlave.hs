...
instance ToJSON PdfSlaveTemplate where
  toJSON template = Yaml.toJSON template
...
convertCrystalToPdfSlave cr = PdfSlaveTemplate
  { ptMeta = PdfSlaveMeta
      { pmTitle = crName cr
...
convertSection (Just (ReportHeaderSection objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
convertSection (Just (PageHeaderSection objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
convertSection (Just (ReportFooterSection objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
convertSection (Just (PageFooterSection objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
convertSection (Just (GroupHeaderSection _ objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
convertSection (Just (GroupFooterSection _ objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
...
convertDetailSection (Just (DetailSection objs)) = Just PdfSlaveSection
  { psHeight = Nothing
  , psElements = map convertObject objs
  }
...
convertObject (TextObject cto) = TextElement PdfSlaveText
  { ptX = ctoX cto
  , ptY = ctoY cto
...
convertObject (FieldObject cfo) = TextElement PdfSlaveText
  { ptX = cfoX cfo
  , ptY = cfoY cfo
...
convertObject (FormulaObject cformula) = TextElement PdfSlaveText
...
convertObject (LineObject clo) = LineElement PdfSlaveLine
  { plX1 = cloX1 clo
  , plY1 = cloY1 clo
  , plX2 = cloX2 clo
  , plY2 = cloY2 clo
...
convertObject (BoxObject cbo) = RectElement PdfSlaveRect
  { prX = cboX cbo
  , prY = cboY cbo
...
convertObject (SubreportObject cs) = TextElement PdfSlaveText
  { ptX = csX cs
  , ptY = csY cs
...
convertObject (GraphObject cgo) = TextElement PdfSlaveText
  { ptX = cgoX cgo
  , ptY = cgoY cgo
  ...
  , crSections =
      [ ReportHeaderSection
          [ TextObject CrystalTextObject
              { ctoX = 10, ctoY = 10, ctoWidth = 190, ctoHeight = 10
              , ctoText = "INVOICE", ctoFontSize = Just 18, ctoFontName = Just "Arial"
              , ctoBold = True, ctoItalic = False, ctoAlignment = "center"
              }
          , TextObject CrystalTextObject
              { ctoX = 10, ctoY = 25, ctoWidth = 190, ctoHeight = 5
              , ctoText = "{{companyName}}", ctoFontSize = Just 12
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "center"
              }
          ]
      , PageHeaderSection
          [ TextObject CrystalTextObject
              { ctoX = 10, ctoY = 40, ctoWidth = 30, ctoHeight = 5
              , ctoText = "Name", ctoFontSize = Just 10
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "left"
              }
          , TextObject CrystalTextObject
              { ctoX = 50, ctoY = 40, ctoWidth = 30, ctoHeight = 5
              , ctoText = "Qty", ctoFontSize = Just 10
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "right"
              }
          , TextObject CrystalTextObject
              { ctoX = 90, ctoY = 40, ctoWidth = 30, ctoHeight = 5
              , ctoText = "Price", ctoFontSize = Just 10
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "right"
              }
          , TextObject CrystalTextObject
              { ctoX = 130, ctoY = 40, ctoWidth = 30, ctoHeight = 5
              , ctoText = "Sum", ctoFontSize = Just 10
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "right"
              }
          , LineObject CrystalLineObject
              { cloX1 = 10, cloY1 = 47, cloX2 = 190, cloY2 = 47
              , cloThickness = Just 1
              }
          ]
      , DetailSection
          [ FieldObject CrystalFieldObject
              { cfoX = 10, cfoY = 50, cfoWidth = 30, cfoHeight = 5
              , cfoFieldName = "name", cfoFormat = Nothing
              }
          , FieldObject CrystalFieldObject
              { cfoX = 50, cfoY = 50, cfoWidth = 30, cfoHeight = 5
              , cfoFieldName = "quantity", cfoFormat = Nothing
              }
          , FieldObject CrystalFieldObject
              { cfoX = 90, cfoY = 50, cfoWidth = 30, cfoHeight = 5
              , cfoFieldName = "price", cfoFormat = Nothing
              }
          , FieldObject CrystalFieldObject
              { cfoX = 130, cfoY = 50, cfoWidth = 30, cfoHeight = 5
              , cfoFieldName = "sum", cfoFormat = Nothing
              }
          ]
      , ReportFooterSection
          [ LineObject CrystalLineObject
              { cloX1 = 10, cloY1 = 270, cloX2 = 190, cloY2 = 270
              , cloThickness = Just 1
              }
          , TextObject CrystalTextObject
              { ctoX = 130, ctoY = 275, ctoWidth = 30, ctoHeight = 5
              , ctoText = "Total: {{total}}", ctoFontSize = Just 10
              , ctoFontName = Just "Arial", ctoBold = True, ctoItalic = False
              , ctoAlignment = "right"
              }
          ]
