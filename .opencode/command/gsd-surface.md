...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/domini/src/My/Surypus/.opencode/.gsd-surface.json`
(sibling to `/home/domini/src/My/Surypus/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/domini/src/My/Surypus/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`/home/domini/src/My/Surypus/.opencode/skills`).
...
`/home/domini/src/My/Surypus/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/domini/src/My/Surypus/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/domini/src/My/Surypus/.opencode/.gsd-surface.json`
Install profile marker: `/home/domini/src/My/Surypus/.opencode/.gsd-profile`
Skill dirs: `/home/domini/src/My/Surypus/.opencode/skills/gsd-*/`
Engine module: `/home/domini/src/My/Surypus/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/domini/src/My/Surypus/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
