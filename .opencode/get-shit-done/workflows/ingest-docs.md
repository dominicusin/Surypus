...
```bash
INIT=$(node "/home/domini/src/My/Surypus/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/domini/src/My/Surypus/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
