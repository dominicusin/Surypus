...
INSTALL_JS_GLOBAL="/home/domini/src/My/Surypus/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/domini/src/My/Surypus/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
